...
M65C02Context.prototype.op_func_tbl = [
  ...
  function op01(this_) {
    this_._tmp1 =
      (this_.memmap[this_.reg_pc >> 13][this_.reg_pc & 0x1fff] + this_.reg_x) &
      0xff
    this_._addr =
      ((this_._tmp1 < 0xffff
        ? this_.memmap[(this_._tmp1 + 1) >> 13][(this_._tmp1 + 1) & 0x1fff]
        : this_.ram[0]) <<
        8) |
      this_.memmap[this_._tmp1 >> 13][this_._tmp1 & 0x1fff]
    this_.reg_pc = (this_.reg_pc + 1) & 0xffff
    this_.reg_a |= this_.io_read_map[this_._addr]
      ? this_.io_read(this_._addr)
      : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]
  ...
  function op04(this_) {
    ...
    this_.reg_pc = (this_.reg_pc + 1) & 0xffff
    this_._tmp1 = this_.io_read_map[this_._addr]
      ? this_.io_read(this_._addr)
      : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]
  ...
  function op06(this_) {
    ...
    this_.reg_pc = (this_.reg_pc + 1) & 0xffff
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) << 1
  ...
  function op07(this_) {
    ...
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0xfe
    this_.flag_n = (this_._tmp1 & 0x80) >> 7
    this_.flag_z = this_._tmp1 & 0xff ? 0 : 1
    if (this_.io_write_map[this_._addr]) {
  ...
  function op0C(this_) {
    this_._addr =
      ((this_.reg_pc < 0xffff
        ? this_.memmap[(this_.reg_pc + 1) >> 13][(this_.reg_pc + 1) & 0x1fff]
        : this_.ram[0]) <<
        8) |
      this_.memmap[this_.reg_pc >> 13][this_.reg_pc & 0x1fff]
  ...
  function op0F(this_) {
    ...
    if (
      !(
        (this_.io_read_map[this_._addr]
          ? this_.io_read(this_._addr)
          : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x01
      )
    ) {
  ...
  function op12(this_) {
    this_._tmp1 = this_.memmap[this_.reg_pc >> 13][this_.reg_pc & 0x1fff]
    this_._addr =
      ((this_._tmp1 < 0xff ? this_.ram[this_._tmp1 + 1] : this_.ram[0]) << 8) |
      this_.ram[this_._tmp1]
    this_.reg_pc = (this_.reg_pc + 1) & 0xffff
    this_.reg_a |= this_.io_read_map[this_._addr]
      ? this_.io_read(this_._addr)
      : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]
  ...
  function op17(this_) {
    ...
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0xfd
    this_.flag_n = (this_._tmp1 & 0x80) >> 7
    this_.flag_z = this_._tmp1 & 0xff ? 0 : 1
    if (this_.io_write_map[this_._addr]) {
      this_.io_write(this_._addr, this_._tmp1)
  ...
  function op1F(this_) {
    ...
    if (
      !(
        (this_.io_read_map[this_._addr]
          ? this_.io_read(this_._addr)
          : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x02
      )
    ) {
      this_.reg_pc = (this_.reg_pc + this_._tmp2) & 0xffff
      this_.cycles++
  ...
  function op27(this_) {
    ...
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0xfb
    this_.flag_n = (this_._tmp1 & 0x80) >> 7
    this_.flag_z = this_._tmp1 & 0xff ? 0 : 1
    if (this_.io_write_map[this_._addr]) {
      this_.io_write(this_._addr, this_._tmp1)
  ...
  function op28(this_) {
    this_.set_reg_ps(
      this_.ram[(this_.reg_sp = (++this_.reg_sp & 0xff) | 0x100)]
    )
    this_.cycles += 4
  },
  function op29(this_) {
  ...
  function op2F(this_) {
    ...
    if (
      !(
        (this_.io_read_map[this_._addr]
          ? this_.io_read(this_._addr)
          : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x04
      )
    ) {
      this_.reg_pc = (this_.reg_pc + this_._tmp2) & 0xffff
      this_.cycles++
  ...
  function op37(this_) {
    ...
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0xf7
    this_.flag_n = (this_._tmp1 & 0x80) >> 7
    this_.flag_z = this_._tmp1 & 0xff ? 0 : 1
    if (this_.io_write_map[this_._addr]) {
      this_.io_write(this_._addr, this_._tmp1)
  ...
  function op3F(this_) {
    ...
    if (
      !(
        (this_.io_read_map[this_._addr]
          ? this_.io_read(this_._addr)
          : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x08
      )
    ) {
      this_.reg_pc = (this_.reg_pc + this_._tmp2) & 0xffff
      this_.cycles++
  ...
  function op40(this_) {
    ...
    this_.reg_pc |=
      this_.ram[(this_.reg_sp = (++this_.reg_sp & 0xff) | 0x100)] << 8
    this_.cycles += 6
  },
  function op41(this_) {
    this_._tmp1 =
  ...
  function op47(this_) {
    ...
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0xef
    this_.flag_n = (this_._tmp1 & 0x80) >> 7
    this_.flag_z = this_._tmp1 & 0xff ? 0 : 1
    if (this_.io_write_map[this_._addr]) {
      this_.io_write(this_._addr, this_._tmp1)
  ...
  function op4F(this_) {
    ...
    if (
      !(
        (this_.io_read_map[this_._addr]
          ? this_.io_read(this_._addr)
          : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x10
      )
    ) {
      this_.reg_pc = (this_.reg_pc + this_._tmp2) & 0xffff
      this_.cycles++
  ...
  function op57(this_) {
    ...
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0xdf
    this_.flag_n = (this_._tmp1 & 0x80) >> 7
    this_.flag_z = this_._tmp1 & 0xff ? 0 : 1
    if (this_.io_write_map[this_._addr]) {
      this_.io_write(this_._addr, this_._tmp1)
  ...
  function op5F(this_) {
    ...
    if (
      !(
        (this_.io_read_map[this_._addr]
          ? this_.io_read(this_._addr)
          : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x20
      )
    ) {
      this_.reg_pc = (this_.reg_pc + this_._tmp2) & 0xffff
      this_.cycles++
  ...
  function op61(this_) {
    ...
    if (this_.flag_d) {
      this_._tmp2 =
        (this_.reg_a >> 4) * 10 +
        (this_.reg_a & 0x0f) +
        ((this_._tmp1 >> 4) * 10 + (this_._tmp1 & 0x0f)) +
        this_.flag_c
      ...
      this_.flag_v =
        ((this_.reg_a ^ this_._tmp1 ^ 0x80) &
          (this_.reg_a ^ this_._tmp2) &
          0x80) >>
        7
  ...
  function op67(this_) {
    ...
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0xbf
    this_.flag_n = (this_._tmp1 & 0x80) >> 7
    this_.flag_z = this_._tmp1 & 0xff ? 0 : 1
    if (this_.io_write_map[this_._addr]) {
      this_.io_write(this_._addr, this_._tmp1)
  ...
  function op6F(this_) {
    ...
    if (
      !(
        (this_.io_read_map[this_._addr]
          ? this_.io_read(this_._addr)
          : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x40
      )
    ) {
      this_.reg_pc = (this_.reg_pc + this_._tmp2) & 0xffff
      this_.cycles++
  ...
  function op77(this_) {
    ...
    this_._tmp1 =
      (this_.io_read_map[this_._addr]
        ? this_.io_read(this_._addr)
        : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x7f
    this_.flag_n = (this_._tmp1 & 0x80) >> 7
    this_.flag_z = this_._tmp1 & 0xff ? 0 : 1
    if (this_.io_write_map[this_._addr]) {
      this_.io_write(this_._addr, this_._tmp1)
  ...
  function op7F(this_) {
    ...
    if (
      !(
        (this_.io_read_map[this_._addr]
          ? this_.io_read(this_._addr)
          : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]) & 0x80
      )
    ) {
      this_.reg_pc = (this_.reg_pc + this_._tmp2) & 0xffff
      this_.cycles++
  ...
  function op96(this_) {
    this_._addr =
      (this_.memmap[this_.reg_pc >> 13][this_.reg_pc & 0x1fff] + this_.reg_y) &
      0xff
    this_.reg_pc = (this_.reg_pc + 1) & 0xffff
    if (this_.io_write_map[this_._addr]) {
      this_.io_write(this_._addr, this_.reg_x)
  ...
  function opA0(this_) {
    this_._addr = this_.reg_pc
    this_.reg_pc = (this_.reg_pc + 1) & 0xffff
    this_.reg_y = this_.io_read_map[this_._addr]
      ? this_.io_read(this_._addr)
      : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]
    this_.flag_n = (this_.reg_y & 0x80) >> 7
    this_.flag_z = this_.reg_y & 0xff ? 0 : 1
  ...
  function opA2(this_) {
    this_._addr = this_.reg_pc
    this_.reg_pc = (this_.reg_pc + 1) & 0xffff
    this_.reg_x = this_.io_read_map[this_._addr]
      ? this_.io_read(this_._addr)
      : this_.memmap[this_._addr >> 13][this_._addr & 0x1fff]
  ...
  function opE1(this_) {
    ...
    if (this_.flag_d) {
      ...
      this_.flag_c = this_._tmp2 < 0 ? 0 : 1
      this_.flag_v =
        ((this_.reg_a ^ this_._tmp1) & (this_.reg_a ^ this_._tmp2) & 0x80) >> 7
      this_.reg_a = this_._tmp2 & 0xff
      this_.flag_n = (this_.reg_a & 0x80) >> 7
      this_.flag_z = this_.reg_a & 0xff ? 0 : 1
    }
